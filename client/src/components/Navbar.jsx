    ...
    return (
        <div className='shadow py-4'>
            <div className='container px-4 2xl:px-20 mx-auto flex justify-between items-center'>
                <img
                    onClick={() => navigate('/')}
                    className='cursor-pointer h-14 sm:h-16 md:h-[4.5rem] w-auto max-w-[min(340px,58vw)] object-contain object-left shrink-0'
                    src={assets.logo}
                    alt="JobLens"
                />
                {
                    user
                        ? <div className='flex items-center gap-3'>
                            ...
                            <p>|</p>
                            <Link to={'/ai-resume-analyzer'}>Resume AI</Link>
                            <p>|</p>
