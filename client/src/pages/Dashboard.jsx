...
const Dashboard = () => {
    ...
    useEffect(() => {
        // Redirect only when recruiter lands on the dashboard root.
        // Avoid forcing navigation while switching sidebar pages.
        ...
        <div className='min-h-screen'>
            ...
            <div className='shadow py-4'>
                <div className='px-5 flex justify-between items-center'>
                    <img
                        onClick={() => navigate('/')}
                        className='h-14 sm:h-16 md:h-[4.5rem] w-auto max-w-[min(340px,55vw)] object-contain object-left cursor-pointer shrink-0'
                        src={assets.logo}
                        alt="JobLens"
                    />
                    {companyData && (
